...
When the account is created, the user moves to the swiping-page where they will be presented with two new people through their profile “cards”. These cards presents the name, age, bio and picture of two other accounts on the app. The user must now choose which one of these two they likes best, or if they doesn't like any of them they will be able to refresh the swiping page so that they can be presented with two new people. When the user has decided which person they prefers they "discards" or swipes away the one they likes the least. The one the user preferred will remain on the page and they will be presented with a new person. Again they has to choose which person they likes the best. If they likes the same person over the other three times then a "proper" like to that person is registered. If that person has liked the user over someone else three times also, there will be a match. On another page in the app the user has the opportunity to see an overview of their matches, as well as their contact information. From here on they have the chance to connect and meet in real life.

Because the users have to like a person over someone else three times it adds some legitimacy to the connection. One can be more certain that there is a mutual interest between users when they use Xcitr. However one will naturally be interested in more than one person. On the app there will be an overview of all the matches one has made, so that the user can easily go back and find the contact information to all of the people they have matched with.
...
<div align="center"> 
    <img width="600" src = "/uploads/765d031d49de6fec20cbb817ebfb0539/notification.png"> 
</div>
...
<div align="center">
    <img width="600" src="/uploads/03b41c6c4ba6c06d322bed02ed999818/loggut_gå_tilbake.png">
</div>
...
<div align="center">
    <img width="600" src="/uploads/5a2de4f22bd77c61edc237b770514bde/velge_avatar.png">
</div>
