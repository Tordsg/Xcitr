...
public class MessageHandlerTest {
  ...
  public void testsendMessage() {
    chat.sendMessage(user1.getEmail(), "Hello");
    chat.sendMessage(user2.getEmail(), "Hello");
    chat.sendMessage(user1.getEmail(), "how are you?");
    chat.sendMessage(user2.getEmail(), "I am fine");
  ...
  public void testAddedChats() {
    ...
    messageHandler.saveChat(chat);
    chat.sendMessage(user1.getEmail(), "message");
    messageHandler.saveChat(chat);
  ...
  public void testNewChat() {
    ...
    chat3.sendMessage(user3.getEmail(), "Hello");
    chat3.sendMessage(user4.getEmail(), "Hello");
